...
func newUserSession(db *gorm.DB, opts ...gen.DOOption) userSession {
	...
	_userSession.RefreshTokenHash = field.NewField(tableName, "refresh_token_hash")
	...
	_userSession.LastUsedAt = field.NewTime(tableName, "last_used_at")
	_userSession.IdleExpiresAt = field.NewTime(tableName, "idle_expires_at")
	_userSession.ExpiresAt = field.NewTime(tableName, "expires_at")
	_userSession.RevokedAt = field.NewTime(tableName, "revoked_at")
	_userSession.RevokeReason = field.NewString(tableName, "revoke_reason")
	_userSession.RotatedFromSessionID = field.NewString(tableName, "rotated_from_session_id")
...
type userSession struct {
	...
	ID                   field.String
	UserID               field.String
	RefreshTokenHash     field.Field
	DeviceID             field.String
	IP                   field.String
	UserAgent            field.String
	CreatedAt            field.Time
	LastUsedAt           field.Time
	IdleExpiresAt        field.Time
	ExpiresAt            field.Time
	RevokedAt            field.Time
	RevokeReason         field.String
	RotatedFromSessionID field.String
...
func (u *userSession) updateTableName(table string) *userSession {
	...
	u.RefreshTokenHash = field.NewField(table, "refresh_token_hash")
	...
	u.IdleExpiresAt = field.NewTime(table, "idle_expires_at")
	...
	u.RotatedFromSessionID = field.NewString(table, "rotated_from_session_id")
