...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.PasswordSetAt = field.NewTime(tableName, "password_set_at")
	_user.PinSetAt = field.NewTime(tableName, "pin_set_at")
	_user.OnboardingCompletedAt = field.NewTime(tableName, "onboarding_completed_at")
	_user.FailedLoginCount = field.NewInt32(tableName, "failed_login_count")
...
type user struct {
	...
	Status                field.String
	PasswordSetAt         field.Time
	PinSetAt              field.Time
	OnboardingCompletedAt field.Time
	FailedLoginCount      field.Int32
...
func (u *user) updateTableName(table string) *user {
	...
	u.PasswordSetAt = field.NewTime(table, "password_set_at")
	u.PinSetAt = field.NewTime(table, "pin_set_at")
	u.OnboardingCompletedAt = field.NewTime(table, "onboarding_completed_at")
	u.FailedLoginCount = field.NewInt32(table, "failed_login_count")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["password_set_at"] = u.PasswordSetAt
	u.fieldMap["pin_set_at"] = u.PinSetAt
	u.fieldMap["onboarding_completed_at"] = u.OnboardingCompletedAt
